...
const slides: OnboardingSlide[] = [
  {
    ...
    kicker: 'HIMALAYAN STAYS',
    headlineLight: 'Mountain Homes,',
    headlineBold: 'Hosted Locally',
    subtitle: 'Homestays and villas across Himachal & Uttarakhand.',
  },
  {
    id: '2',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=1200&auto=format&fit=crop&q=80',
    kicker: 'FAIR PRICING',
    headlineLight: 'Direct Bookings,',
    headlineBold: '2% Fee',
    subtitle: 'More earnings for hosts. Clear prices for guests.',
  },
  {
    id: '3',
    image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&auto=format&fit=crop&q=80',
    kicker: 'CURATED STAYS',
    headlineLight: 'Stays for',
    headlineBold: 'Slow Days',
    subtitle: 'Work-friendly homestays and villas with verified essentials.',
  },
];
